...
// Kobold-owned equivalent of qml/JGListView.qml, kept in this module so the
// device/logical/keyboard input panels don't reach across into qml/ for a
// plain list-view helper. Named distinctly (not "ListView") because a
