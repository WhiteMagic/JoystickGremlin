...
class Ui_Gremlin(object):
    def setupUi(self, Gremlin):
        ...
        self.actionLoadAsTemplate = QtWidgets.QAction(Gremlin)
        self.actionLoadAsTemplate.setObjectName("actionLoadAsTemplate")
        ...
        self.menu_File.addAction(self.actionLoadAsTemplate)
        self.menu_File.addSeparator()
    ...
    def retranslateUi(self, Gremlin):
        ...
        self.actionLoadAsTemplate.setText(_translate("Gremlin", "Load as Template"))
