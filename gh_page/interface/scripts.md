...
The panel shows a list of configured variables with their name and configuration being shown. Variables that have to be configured have a red mark next to their name.
