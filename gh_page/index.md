...
- [Universal Control Remapper](https://github.com/Snoothy/UCR){:target="_blank"} (successor to UJR)
- [FreePie](https://andersmalmgren.github.io/FreePIE/){:target="_blank"}
- [AutoHotkey](http://ahkscript.org/){:target="_blank"}
- [Universal Joystick Remapper](https://github.com/evilC/AHK-Universal-Joystick-Remapper){:target="_blank"}
- Joystick Curves (defunct)
