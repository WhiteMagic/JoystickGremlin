...
"C:\Program Files (x86)\WiX Toolset v3.10\bin\candle.exe" joystick_gremlin.wxs
"C:\Program Files (x86)\WiX Toolset v3.10\bin\light.exe" -ext WixUiExtension joystick_gremlin.wixobj
