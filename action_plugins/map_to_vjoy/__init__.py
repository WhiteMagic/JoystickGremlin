...
class MapToVjoyFunctor(AbstractFunctor):
    ...
    def __init__(self, action: MapToVjoyModel):
...
class MapToVjoyModel(AbstractActionModel):
    ...
    def to_xml(self) -> ElementTree.Element:
        node = util.create_action_node(MapToVjoyModel.tag, self._id)
